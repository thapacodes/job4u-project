    ...
    <div class="container-fluid">
        <div class="d-flex w-100 justify-content-between justify-content-lg-end">
            ...
            <div class="d-flex">
                <div class="me-3">
                    @php
                        $unreadCount = \App\Models\Notification::where('status', null)->count();
                    @endphp
                    <a type="button" class="btn btn-secondary position-relative"
                        href="{{ env('APP_URL') }}/dashboard/notification">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark rounded-0" aria-labelledby="admin-user-dropdown">
                        @if (Auth::user()['role'] == 'admin')
                            <li><a class="dropdown-item" href="{{ env('APP_URL') }}/dashboard/change-password">Change
                                    Password</a></li>
